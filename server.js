...
// stampa “testo” su file (opzionale)
async function printOrder(orderId) {
  try {
    ...
    if (process.env.PRINT_TO_FILES === 'true') {
      ...
      fs.writeFileSync(path.join(dir, order_${o.code}.txt), lines.join('\n') + '\n', 'utf8')
    }
  } catch (e) {
...
app.get('/:restaurant/table/:code', (req, res) => {
  ...
  // immagine “di categoria” di fallback (Unsplash Source)
  const catImg = (name = '') => {
